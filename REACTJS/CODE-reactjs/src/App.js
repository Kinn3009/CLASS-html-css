  ...
  const tabData = [
    {
      value: 1,
      content:
        "Tab 1 ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores",
      title: "History",
    },
    {
      value: 2,
    ...
    },
    {
      value: 3,
      content:
        "Tab 3 ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores",
      title: "Class",
    },
    {
      value: 4,
      content:
        "Tab 4 ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores",
      title: "Student",
    },
    {
      value: 5,
      content:
        "Tab 5 ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores",
      title: "Tab 5",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        {tabData.map((tabItem) => {
          const { value, title } = tabItem;
          return (
            <button
              className={`btn-tab ${tab.value === value ? "active" : ""}`}
      ...
      {/* <div className="App">
        ...
        <Block
          title="Đây là Block 1"
          number={1}
          description="Thiện Đẹp Trai"
          isInside={false}
        />
    ...
    <div className="tab__item" onClick={() => onClick(value)}>
      <div
        className={`tab__title ${
          value === activeTab ? "tab__ti  tle--active" : ""
        }`}
      >
        {title}
      </div>
